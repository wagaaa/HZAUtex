% HUSTproposal.tex @ https://gitee.com/wagaaa/HZAUtex
%
% 	A simple tex template for the undergraduate thesis proposal at HZAU.
%
% author: Jerry @ 2022
...
%% For the header and footer. 页眉，页脚
 ...
 %设置页眉样式
 \newcommand{\headstyle}{
 	\fancyhead[C]{ \hwzs\wuhao 华中农业大学本科生毕业设计（论文）开题报告}
 }
 %设置页脚样式
...
% \lhead{} \chead{华中农业大学本科生毕业设计（论文）参考文献译文} \rhead{}
...
%\DeclareCaptionFont{HZAU}{\normalsize}
%\captionsetup{labelsep=quad}
%\captionsetup{font={HZAU,singlespacing}}
