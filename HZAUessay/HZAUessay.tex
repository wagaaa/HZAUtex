% HZAUessay.tex @ https://github.com/zfengg/HZAUtex/tree/master/HZAUessay
%
% 	A simple tex template for the undergraduate essay at HZAU.
%
...
% 设置页眉样式
\newcommand{\headstyle}{
 \fancyhead[C]{ \hwzs\wuhao 课\hspace{0.5em}程\hspace{0.5em}结\hspace{0.5em}业\hspace{0.5em}论\hspace{0.5em}文}
}
% 设置页脚样式
...
% \renewcommand{\bibname}{HZAUessay} % .bib name
...
%
			\vspace*{5em}
%
			{\xiaochuhao \hwzs \bfseries 课程结课[论文]}\\
%
			\vspace*{4em}
...
\bibliography{HZAUessay}\label{bibtexref}
