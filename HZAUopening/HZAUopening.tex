...
%
% 	A simple tex for the opening task of the undergraduate thesis at HZAU.
%
% originnal author: Zhou Feng @ 2019
% modified by Jerry Wang
% requirements:
...
%----------------------------------------------------------------%
%% 设置幻灯片的格式 set the theme, colorstyle, and other options for this beamer slides. I have included many alternative options for you. As a student from HZAU, I prefer the default Madrid theme.
\mode<presentation> {
